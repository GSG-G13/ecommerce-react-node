            ...
            <div class="products-container">
                <div class="product">
                    ...
                    <div class="more">
                        ...
                        <p>The new Moto 360 combines edge-to-edge glass with an exceptionally thin, polished bezel,
                            giving you the largest viewing area. Whether...</p>
                        <div class="options">
                ...
                <div class="product">
                    ...
                    <div class="more">
                        <div class="add-to-cart">Add to cart</div>
                        <p>iPhone 6 isn't just bigger — it's better in every way. Larger yet thinner. More powerful, yet
                            power efficient. It's...</p>
                        <div class="options">
                            <span><i class="fa-regular fa-heart"></i>add to wishlist</span>
                            <span><i class="fa-solid fa-code-compare"></i>compare</span>
                        </div>
                ...
                <div class="product">
                    ...
                    <div class="more">
                        <div class="add-to-cart">Add to cart</div>
                        <p>Meet Xperia Z2. An Android phone that allows you to take photos and videos like never before.
                            For moments you'll...</p>
                        <div class="options">
                            <span><i class="fa-regular fa-heart"></i>add to wishlist</span>
                            <span><i class="fa-solid fa-code-compare"></i>compare</span>
                        </div>
                ...
                <div class="product">
                    ...
                    <div class="more">
                        <div class="add-to-cart">Add to cart</div>
                        <p>Add multi-touch gesture support to one of Wacom's most versatile creative pen displays. This
                            is a Demo Online Store. No...</p>
                        <div class="options">
                            <span><i class="fa-regular fa-heart"></i>add to wishlist</span>
                            <span><i class="fa-solid fa-code-compare"></i>compare</span>
                        </div>
                ...
                <div class="product">
                    ...
                    <div class="more">
                        <div class="add-to-cart">Add to cart</div>
                        <p>Completely redesigned, the Beats Studio over-ear headphones are even lighter, stronger, and
                            more comfortable, and more precise than the original...</p>
                        <div class="options">
                            <span><i class="fa-regular fa-heart"></i>add to wishlist</span>
                            <span><i class="fa-solid fa-code-compare"></i>compare</span>
                        </div>
                ...
                <div class="product">
                    ...
                    <div class="more">
                        <div class="add-to-cart">Add to cart</div>
                        <p>Engineered from the ground up to provide a superior personal listening experience that
                            sounds, fits, and moves like you. This...</p>
                        <div class="options">
                            <span><i class="fa-regular fa-heart"></i>add to wishlist</span>
                            <span><i class="fa-solid fa-code-compare"></i>compare</span>
                        </div>
                ...
                <div class="product">
                    ...
                    <div class="more">
                        <div class="add-to-cart">Add to cart</div>
                        <p>
                            The idea behind iMac has never wavered: to craft the ultimate desktop experience. The best
                            display, paired with high-performance processors,...</p>
                        <div class="options">
                            <span><i class="fa-regular fa-heart"></i>add to wishlist</span>
                            <span><i class="fa-solid fa-code-compare"></i>compare</span>
                        </div>
                ...
                <div class="product">
                    ...
                    <div class="more">
                        <div class="add-to-cart">Add to cart</div>
                        <p>There's more to mini than meets the eye. The new iPad mini 4 puts uncompromising performance
                            and potential in your...</p>
                        <div class="options">
                            <span><i class="fa-regular fa-heart"></i>add to wishlist</span>
                            <span><i class="fa-solid fa-code-compare"></i>compare</span>
                        </div>
                ...
                <div class="product">
                    ...
                    <div class="more">
                        <div class="add-to-cart">Add to cart</div>
                        <p>The iPhone 5c replaces the iPhone 5 in the Apple stable, inheriting its internals, like the
                            A6 processor, 4" screen...</p>
                        <div class="options">
                            <span><i class="fa-regular fa-heart"></i>add to wishlist</span>
                            <span><i class="fa-solid fa-code-compare"></i>compare</span>
                        </div>
                ...
                <div class="product">
                    ...
                    <div class="more">
                        <div class="add-to-cart">Add to cart</div>
                        <p>The iPhone 5s is not a radical departure in design for Apple, save for one very important
                            feature. No, we...</p>
                        <div class="options">
                            <span><i class="fa-regular fa-heart"></i>add to wishlist</span>
                            <span><i class="fa-solid fa-code-compare"></i>compare</span>
                ...
                <div class="product">
                    ...
                    <div class="more">
                        ...
                        <p>
                            ...
                            display, paired with high-performance processors,...</p>
                        <div class="options">
                            <span><i class="fa-regular fa-heart heart"></i>add to wishlist</span>
                            <span><i class="fa-solid fa-code-compare"></i>compare</span>
                        </div>
                    </div>
                </div>
    ...
    <footer>
        <div class="container">
            <div class="footer-card">
                ...
                <p>Woodstock is a Modern Fully Responsive Retina Ready Woocommerce theme. Start your Store right away
                    with Woodstock theme.</p>
            </div>
            ...
            <div class="footer-card flex-1">
                ...
                <div class="links">
                    <li><a href="">Oh, Princess Leia, are you all right?</a></li>
                    <li><a href="">Your time is limited</a></li>
                    <li><a href="">Tour of Envato's Melbourne Headquarted</a></li>
                    <li><a href="">TemashDesign Portfolio</a></li>
                </div>
